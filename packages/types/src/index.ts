 ...
 * 不同 ast 需要遍历的属性集合
 */
const astDefinationsMap: Map<string, {
  visitor?: string[]
  isBlock?: boolean
}>  = new Map()
...
const validations: Record<string, (node) => boolean> = {}

for (const name of astDefinationsMap.keys()) {
...
export {
  astDefinationsMap as visitorKeys,
  validations
}